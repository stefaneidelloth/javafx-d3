 ...
 *
 */
public class SvgTextElementFactory implements D3NodeFactory {
	...
	public SvgTextElementFactory(){
		
	}	
	
	public SvgTextElementFactory(String text){
		this.text = text;
	}
	...
	public Selection createInParentSelection(Selection selection) {
		inputElementSelection = selection.append("text")
				.text(text)										
