...
public class MouseMoveDataFunction implements DataFunction<Void> {
	...
	public MouseMoveDataFunction(WebEngine webEngine, D3 d3, Double[][] vertices, Runnable redrawRunnable){
