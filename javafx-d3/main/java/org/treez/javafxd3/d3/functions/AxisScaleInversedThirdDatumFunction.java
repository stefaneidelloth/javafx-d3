...
public class AxisScaleInversedThirdDatumFunction implements DatumFunction<Double> {
	 ...
	 * @param webEngine
	 */
	public AxisScaleInversedThirdDatumFunction(QuantitativeScale<?> scale, double maxValue){
		this.scale = scale;		
