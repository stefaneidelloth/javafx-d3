...
public class AxisScaleInversedSecondDatumFunction implements DatumFunction<Double> {
	 ...
	 * @param webEngine
	 */
	public AxisScaleInversedSecondDatumFunction(QuantitativeScale<?> scale, double maxValue){
		this.scale = scale;		
