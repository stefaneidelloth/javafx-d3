...
public class Area extends PathDataGenerator {
	...
	public Area x0(final DatumFunction<Double> callback) {
		...
		throw new IllegalStateException("not yet implemented");
		/*
		 * return this .x0(function(d, i) { return
		 * callback.@com.github.gwtd3.api.functions.DatumFunction::apply(Lcom/
		 * google/gwt/dom/client/Element;Lcom/github/gwtd3/api/core/Value;I)(
		 * this,{datum:d},i); });
		 * 
	...
	public Area x1(final DatumFunction<Double> callback) {
		...
		throw new IllegalStateException("not yet implemented");
		/*
		 * return this .x1(function(d, i) { return
		 * callback.@com.github.gwtd3.api.functions.DatumFunction::apply(Lcom/
		 * google/gwt/dom/client/Element;Lcom/github/gwtd3/api/core/Value;I)(
		 * this,{datum:d},i); });
		 * 
	...
	public Line defined(final DatumFunction<Boolean> callback) {
		...
		throw new IllegalStateException("not yet implemented");
		/*
		 * return this .defined(function(d) { alert('yo'); var result =
		 * callback.@com.github.gwtd3.api.functions.DatumFunction::apply(Lcom/
		 * google/gwt/dom/client/Element;Lcom/github/gwtd3/api/core/Value;I)(
		 * null,{datum:d}, 0); alert(result); return result; });
		 * 
		 */
	}
