...
public class Drag extends JavaScriptObject implements IsFunction {
	...
	public static enum DragEventType {
		 ...
		 */
		DRAGSTART, /**
					 * Fired when the element is dragged. d3.event will contain
					 * "x" and "y" properties representing the current absolute
					 * drag coordinates of the element. It will also contain
					 * "dx" and "dy" properties representing the element's
					 * coordinates relative to its position at the beginning of
					 * the gesture.
					 */
		DRAG, /**
     ...
     * @return the object Drag.
     */
    public  Drag origin(DatumFunction<Coords> o){
